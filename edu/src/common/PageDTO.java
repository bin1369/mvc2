...
public class PageDTO {
	 ...
	 private String search, keyword; //검색에 필요한 필드
	 private String viewType = "list"; //그리드보기/리스트보기
	...
	public void setTotalList(int totalList) {
		...
		//총 페이지수에 따라 총 블럭수가 결정
		//총 블록수 : 3 블록 = 26 / 10 = 2 ... 6
		//나머지가 있으면  + 1
		...
		//현재 블록번호에 따라 보여지는 페이지 시작/끝 페이지번호가 달라진다.
		//각 블럭의 끝 페이지번호 : 블록번호 * 블록당 보여질 페이지수
		//각 블럭의 시작 페이지번호 : 끝 페이지번호 - (블럭당 보여질 페이지수-1)
		//3블럭일때 21 ~ 26
